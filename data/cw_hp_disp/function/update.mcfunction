...
execute store result score .new_abs cw_hp_disp run data get entity @s AbsorptionAmount
scoreboard players operation .new cw_hp_disp += .new_abs cw_hp_disp
execute store result score .new_max cw_hp_disp run attribute @s minecraft:max_health get
execute store result score .new_max_abs cw_hp_disp run attribute @s minecraft:max_absorption get
scoreboard players operation .new_max cw_hp_disp += .new_max_abs cw_hp_disp
